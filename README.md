...
- [01 — What Dharma Is Not](reflections/01_what_dharma_is_not.html) — the linguistic recovery (the seven meanings of *dharma*, when "religion" became a category) **plus the proof from the Gītā's own context**: Kṛṣṇa and Arjuna and the Kauravas all belong to one tradition, so *para-dharma* in BG 3.35 cannot mean "another religion" — the verse is about Arjuna's temptation to abandon the warrior-life for the renunciate-life (BG 2.5), with explicit illustrations and a "what this is NOT saying" list
