...
- [01 — What Dharma Is Not](reflections/01_what_dharma_is_not.html) — the full case in three converging arguments: (a) **linguistic** — the seven meanings of *dharma*, none of which is "religion"; (b) **historical-empirical** — Megasthenes (c. 302 BCE) and Aśoka's Greek translators at Kandahar (c. 258 BCE) could not translate *dharma* either, both settling for approximations; even with sustained Greco-Indian contact and royal sponsorship, the word resisted, while *artha* and *kāma* translated easily — proving the difficulty is conceptual, not linguistic; (c) **contextual** — Kṛṣṇa, Arjuna, and the Kauravas all belong to one tradition, so *para-dharma* in BG 3.35 cannot mean "another religion"; the verse is about Arjuna's temptation to abandon the warrior-life for the renunciate-life (BG 2.5). Closes with explicit illustrations and a "what this is NOT saying" list
